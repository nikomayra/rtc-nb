...
//   //     if (!token) return [];
//   //     try {
//   //       const result = await chatService.current.fetchMessages(channelName, token);
//   //       return result;
//   //     } catch (error) {
//   //       console.error(`Error fetching messages for channel ${channelName}:`, error);
//   //       showError(`Error fetching messages for channel ${channelName}`);
//   //       return [];
//   //     }
//   //   },
//   //   [token, showError]
...
//     if (!token) return [];
//     try {
//       const result = await chatApi.fetchChannels(token);
//       return result || [];
//     } catch (error) {
//       console.error("Error fetching channels:", error);
//       showError("Error fetching channels");
//       return [];
//     }
//   }, [token, showError]);
...
//           return channel;
//         }else{
//           showError("Error creating channel");
//           return null;
//         }
//       } catch (error) {
...
//       }
//     },
//     [token, showSuccess, wsContext.actions, showError]
//   );
...
//       const success = await chatApi.deleteChannel(channel.name, token).then(() => true);
//       if (success) {
//         showSuccess(`Channel "${channel.name}" deleted successfully`);
//         // Broadcast to other clients
//         wsContext.actions.send({
//           type: MessageType.ChannelUpdate,
...
//         return true;
//       } else {
//         showError("Error deleting channel");
//         return false;
//       }
//     },
//     [token, showSuccess, wsContext.actions, showError]
...
//       }
//       try{
//         const success = await chatApi.leaveChannel(channelName, token).then(() => true);
//         if (success) {
//           wsContext.actions.disconnectChannel();
//           return true;
//         }else{
//           showError("Error leaving channel");
//           return false;
//         }
//       } catch (error) {
...
//       }
//     },
//     [token, wsContext.state.channelConnected, wsContext.actions, username, showError]
//   );
...
//       const success = await chatApi.joinChannel(channelName, token, password).then((response) => {
